...
<SafeAreaView style={{backgroundColor:'black', flex:1}}>
  ...
  <View style={Styles.HomeTopView}>
        ...
        <ScrollView horizontal contentContainerStyle={Styles.headerButtonsView}>
          ...
          <TouchableOpacity style={{...Styles.comingSoonView,backgroundColor:buttonIndex==1?'white':'black'}} onPress={()=>setButtonIndex(1)}>
          ...
          <TouchableOpacity style={{...Styles.comingSoonView,backgroundColor:buttonIndex==2?'white':'black'}} onPress={()=>setButtonIndex(2)}>
